...
我们已经安装好了hexo框架，它使用的是默认主题：landscape。如果想要让我们的博客更加定制化，就需要使用其他集成较好的第三方主题。
主题不限，挑自己喜欢的，我选择的是NexT主题。以下是转载的NexT主题的配置文件说明。
~~~yaml
# ---------------------------------------------------------------
# 主题核心配置
# ---------------------------------------------------------------
...
> 转载链接：
>
> [Hexo+NexT（三）：Next主题配置详解](https://blog.csdn.net/loze/article/details/94210320)